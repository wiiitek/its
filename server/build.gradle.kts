...
dependencyManagement {
    ...
    dependencies {
        ...
        dependency("io.projectreactor.netty:reactor-netty-http:1.1.19")
        dependency("io.netty:netty-codec-http:4.1.110.Final")
        // https://spring.io/security/cve-2024-22262
        dependency("org.springframework:spring-web:6.1.7")
    }
}
